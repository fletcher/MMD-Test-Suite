...
This is a formatted \includegraphics[width=40pt,height=400pt]{http://path.to/image} and a \href{http://path.to/link.html}{link}\footnote{\href{http://path.to/link.html}{http:/\slash path.to\slash link.html}} with attributes.
...
\part{Broken Link and Image}
\label{brokenlinkandimage}
